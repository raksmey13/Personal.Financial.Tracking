...
return (
  <div className="p-8 bg-[#F8F9FD] dark:bg-[#0B0F17] min-h-screen relative transition-colors">
        ...
        enhancedAccounts.map((acc) => {
          ...
          return (
            <div
              ...
              className={`bg-white dark:bg-[#151D2A] p-5 rounded-xl shadow-sm border transition-all duration-200 cursor-pointer relative ${
                isExpanded ? "border-blue-400 ring-2 ring-blue-50/50 dark:ring-blue-900/40 shadow-md" : "border-gray-100 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700"
              }`}
            >
              {showsDueWarning && (
              ...
              <div className="flex justify-between items-center">
                <div className="space-y-2">
                  <div className="flex items-center gap-2 flex-wrap">
                    <h3 className="font-bold text-gray-800 dark:text-gray-100 text-lg capitalize">{acc.account_name}</h3>
                ...
                <div className="text-right space-y-2">
                  ...
                  <div className="flex gap-4 text-gray-400 dark:text-gray-400 justify-end items-center relative" onClick={(e) => e.stopPropagation()}>
                    <FaSyncAlt
                    ...
                    <div
                      ...
                      className="cursor-pointer hover:text-blue-500 p-1 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800"
                    >
                      <FaEllipsisV size={14} />
                    </div>

                    {activeMenuId === acc.id && (
                      <div className="absolute right-0 top-6 w-36 bg-white dark:bg-[#1E293B] border border-gray-100 dark:border-gray-700 rounded-xl shadow-xl py-2 z-30 text-left overflow-hidden">
                        <button
                          type="button"
          ...
          <form onSubmit={handleSave} className="p-6 overflow-y-auto space-y-4 text-sm flex-1 custom-scrollbar">
            ...
            {formData.account_type === "Credit Card" && (
              <div className="animate-in fade-in duration-150">
                ...
                <input
                  ...
                  className="w-full border border-amber-300 dark:border-amber-700 bg-amber-50/10 dark:bg-amber-950/20 text-amber-900 dark:text-amber-200 rounded-xl px-3 py-2.5 focus:outline-none focus:border-amber-500 font-bold"
            ...
            {!["Normal", "Savings", "Cash"].includes(formData.account_type) && (
              <div className="animate-in fade-in duration-150 relative" ref={dayDropdownRef}>
                ...
                {isDayDropdownOpen && (
                  <div className="absolute left-0 right-0 mt-1 bg-white dark:bg-[#1E293B] border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl z-[200] max-h-48 overflow-y-auto custom-scrollbar py-1">
                    <div
                    ...
                    {Array.from({ length: 31 }, (_, i) => i + 1).map((day) => (
                      <div
                        ...
                        className={`px-4 py-2 hover:bg-blue-50 dark:hover:bg-blue-950/50 cursor-pointer font-semibold transition-colors ${
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 dark:border-gray-700 bg-white dark:bg-[#1E293B] text-gray-800 dark:text-gray-100 rounded-xl px-3 py-2.5 focus:outline-none font-semibold"
            ...
            <div className="flex justify-end items-center gap-4 pt-4 border-t border-gray-100 dark:border-gray-800 flex-shrink-0">
              <button
                type="button"
