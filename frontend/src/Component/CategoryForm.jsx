...
const CategoryForm = () => {
  ...
  return (
    <div className="max-w-full mx-auto min-h-screen bg-[#f8f9fd] dark:bg-[#0b0f17] p-6 lg:p-8 relative transition-colors">
              ...
              return (
                <div key={mainCat.id} className="space-y-1 mb-4">
                  ...
                  <div
                    ...
                    className={`flex items-center justify-between p-4 hover:bg-gray-50 dark:hover:bg-[#1E293B] rounded-2xl border-b border-gray-50 dark:border-gray-800/50 group transition-all bg-white dark:bg-[#151D2A] ${hasSubCats ? 'cursor-pointer select-none' : ''}`}
                  >
                    <div className="flex items-center gap-5">
                      <div className="w-14 h-14 rounded-2xl bg-blue-50 dark:bg-[#1E293B] flex items-center justify-center text-xl text-blue-600 dark:text-blue-400 overflow-hidden">
                        {renderCategoryIcon(mainCat.icon, mainCat)}
                      </div>

                      <div>
                        <div className="flex items-center gap-2">
                          <h3 className="font-bold text-gray-700 dark:text-gray-100 text-base capitalize">{mainCat.name}</h3>
                          {hasSubCats && (
                            <FaChevronDown
                              size={10}
                    ...
                    <div className="flex items-center gap-6" onClick={(e) => e.stopPropagation()}>
                      <button onClick={() => startEditCategory(mainCat)} className="text-gray-300 dark:text-gray-600 hover:text-blue-500 transition-colors">
                        <FaEdit size={18} />
                      </button>
                      <button onClick={() => handleDeleteCategory(mainCat.id)} className="text-gray-300 dark:text-gray-600 hover:text-red-500 transition-colors">
                  ...
                  {hasSubCats && isExpanded && (
                    <div className="space-y-1 pt-0.5 animate-in fade-in slide-in-from-top-1 duration-200">
                      {subCats.map((subCat) => (
                        <div key={subCat.id} className="flex items-center justify-between p-3 ml-12 bg-gray-50/60 dark:bg-[#1E293B]/60 hover:bg-gray-50 dark:hover:bg-[#1E293B] rounded-xl border border-dashed border-gray-200 dark:border-gray-700 transition-colors">
                          <div className="flex items-center gap-4">
                            <div className="w-10 h-10 rounded-xl bg-white dark:bg-[#151D2A] flex items-center justify-center text-md text-gray-500 dark:text-gray-300 overflow-hidden shadow-sm">
                          ...
                          <div className="flex items-center gap-4 pr-2">
                            <button onClick={() => startEditCategory(subCat)} className="text-gray-300 dark:text-gray-600 hover:text-blue-500 transition-colors">
                              <FaEdit size={16} />
                            </button>
                            <button onClick={() => handleDeleteCategory(subCat.id)} className="text-gray-300 dark:text-gray-600 hover:text-red-500 transition-colors">
