    ...
    <form onSubmit={handleSubmitAll} className="space-y-6">
      ...
      <div className="flex items-center gap-4 bg-blue-50/40 dark:bg-blue-950/20 p-4 rounded-2xl border border-blue-100 dark:border-blue-900/40 transition-colors">
        ...
        <div className="flex-1 grid grid-cols-2 gap-4 items-center">
          <div>
            <label className="block text-gray-700 dark:text-gray-300 text-xs font-semibold mb-1">Target Account</label>
            <select
      ...
      {resolvedType === "income" && isDebtAccount && (
        <div className="bg-amber-50/50 dark:bg-amber-950/20 p-4 rounded-2xl border border-amber-100 dark:border-amber-900/40 space-y-4 animate-in fade-in transition-colors">
          <div>
            <label className="block text-gray-700 dark:text-gray-300 text-xs font-semibold mb-1">Pay From Account (Source Cash/Bank)</label>
            <select
          ...
          {isLoanAccount && (
            <div>
              <div className="flex justify-between items-center mb-1">
                <label className="block text-gray-700 dark:text-gray-300 text-xs font-semibold">Interest / Fee Included in Total (Optional)</label>
                <span className="text-[10px] text-amber-700 dark:text-amber-400 font-medium">Scenario A: Deducted from Total Amount</span>
              </div>
        ...
        {transactions.map((tx, index) => (
          <div key={index} className="flex items-start gap-4 relative group">
            ...
            <div className="flex-1 grid grid-cols-2 gap-4">
              <div>
                <label className="block text-gray-700 dark:text-gray-300 text-xs font-semibold mb-1">Category</label>
                <select
              ...
              <div>
                <label className="block text-gray-700 dark:text-gray-300 text-xs font-semibold mb-1">Total Amount Paid ({currentCurrency})</label>
                <div className="relative flex items-center">
                  <input
                    type="number"
                    step="0.01"
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1 grid grid-cols-2 gap-4">
          <div>
            <label className="block text-gray-700 dark:text-gray-300 text-xs font-semibold mb-1">Date</label>
            <input
              type="date"
          ...
          <div>
            <label className="block text-gray-700 dark:text-gray-300 text-xs font-semibold mb-1">Time</label>
            <input
              type="time"
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <label className="block text-gray-700 dark:text-gray-300 text-xs font-semibold mb-1">Description</label>
          <textarea
            rows="3"
