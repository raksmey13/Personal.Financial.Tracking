...
const ExportImport = ({ mode }) => {
  ...
  const handleExportPDF = async () => {
    ...
    try {
      ...
      if (!token) {
        alert(t("export_import.alert_pdf_failed") || "Session expired. Please log in again.");
      ...
      if (err.response && err.response.status === 401) {
        ...
        alert(t("export_import.alert_pdf_failed") || "Failed to generate PDF. Make sure your server is awake.");
      }
    } finally {
      setIsExportingPdf(false);
    }
