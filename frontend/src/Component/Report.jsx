...
<span className="text-xs font-semibold text-gray-500 dark:text-gray-400">Horizon:</span>
<select
value={forecastSteps}
...
<div>
<label className="block font-semibold text-gray-600 dark:text-gray-400 mb-2">To:</label>
<input
type="date"
value={toDate}
...
<div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
<span className="font-semibold text-gray-600 dark:text-gray-400 w-36">Target Account</span>
<select
...
<div className="flex items-center gap-4">
<span className="font-semibold text-gray-600 dark:text-gray-400 w-36">Include Transactions:</span>
...
<span className="font-semibold text-gray-600 dark:text-gray-400 w-36 pt-1">Chart Representation:</span>
...
<div className="flex items-start gap-4">
<span className="font-semibold text-gray-600 dark:text-gray-400 w-36 pt-1">Grouping Aggregation:</span>
<div className="flex flex-col gap-2 font-bold text-gray-700 dark:text-gray-300">
